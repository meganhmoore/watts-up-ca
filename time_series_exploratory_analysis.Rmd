...
min_temp_ts <- ts(min_temp$`Value`, frequency = 12, start =c(1990,1))
...
max_temp_ts <- ts(max_temp$`Value`, frequency = 12, start =c(1990,1))
...
plot(train_res_1990_transformed)
print(lambda)
```
...
### Model application to other types of electricity consumption
